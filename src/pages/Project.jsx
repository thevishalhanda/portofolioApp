        ...
        <Grid items xs={12} sx={12} md={11} lg={11} align="center">
          <Card elevation={0} style={cardStyle.type}>
            <CardContent>
              ...
              style={headingStyle.type2}> 
              01 / Website
              </p>
              <p
                className = "projectHeading2"
                style = {headingStyle.type2}>
              Weather App
              </p>
              ...
              style={headingStyle.type2}
              >
                The years I spent designing and coding my  work were a complete education in digital product
                <br />
                 development: I understand how elements in a static design will map to the functionality of the 
                 
                 <br />finished product, and the implications of those choices on UX. 
                 <br />
                 If you're like me, and you understand what it takes to create a great digital product,
                 <br />
